...
@bp.route('/api/accept_order', methods=['POST'])
def api_accept_order():
    ...
    db.update_order_status(order_id, 'accepted', partner_id=user.get('id'),
                           partner_name=partner_name, partner_username=partner_username, estimated_time=eta)
